...
def build_dataloader(
    ...
    if dataset == 'cifar10':
        ...
        train_dataset = dataset_list[dataset](root='../cifar-10', train=True, download=False, transform=train_transforms)
        test_dataset = dataset_list[dataset](root='../cifar-10', train=False, transform=test_transforms)
    
    if dataset == 'cifar100':
        train_dataset = dataset_list[dataset](root='../cifar-100', train=True, download=False, transform=train_transforms)
        test_dataset = dataset_list[dataset](root='../cifar-100', train=False, transform=test_transforms)
